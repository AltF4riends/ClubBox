      ...
      backgroundImage: 'url("./gradientBlack.jpeg")',
        ...
        <div
          ...
          style={{
            ...
            <a className="navbar-brand" href={clubInfo.clubTelegram} style={{ color: "white" }} target="_blank">
              <svg
            ...
            <a className="navbar-brand" href={clubInfo.clubLinkedIn} style={{ color: "white" }} target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="75"
                height="75"
            ...
            <a className="navbar-brand" href={clubInfo.clubFacebook} style={{ color: "white" }} target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="75"
                height="75"
